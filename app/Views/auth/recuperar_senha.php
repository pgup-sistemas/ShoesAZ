      ...
      <div class="col-12 col-sm-10 col-md-8 col-lg-5 col-xl-4">
        <div class="card login-card">
          <div class="card-header">
            ...
            <div class="login-subtitle">Recuperação de Senha</div>
          </div>
          <div class="card-body">
            <p class="text-muted small mb-3">Digite seu login para receber instruções de recuperação.</p>

            <form method="post" action="<?= \App\Core\View::url('/recuperar-senha') ?>" class="login-form vstack gap-3">
